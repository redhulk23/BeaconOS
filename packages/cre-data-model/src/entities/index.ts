...
export const PropertySchema = z.object({
  id: z.string(),
  name: z.string(),
  propertyType: z.enum(["office", "retail", "industrial", "multifamily", "mixed_use", "hospitality", "land", "special_purpose"]),
  address: z.string(),
  city: z.string(),
...
export const LeaseSchema = z.object({
  ...
  leaseType: z.enum(["gross", "net", "nn", "nnn", "modified_gross", "percentage", "ground"]),
  ...
  escalationType: z.enum(["fixed", "cpi", "percentage", "step", "none"]).optional(),
...
export const DocumentSchema = z.object({
  ...
  documentType: z.enum(["lease", "amendment", "rent_roll", "t12", "appraisal", "environmental", "survey", "title", "insurance", "other"]),
  fileName: z.string(),
  fileSize: z.number().optional(),
  mimeType: z.string().optional(),
  storagePath: z.string(),
  extractionStatus: z.enum(["pending", "processing", "completed", "failed", "review"]).default("pending"),
...
export const CriticalDateSchema = z.object({
  ...
  leaseId: z.string().optional(),
  propertyId: z.string().optional(),
  dateType: z.enum(["lease_expiration", "renewal_option", "termination_option", "rent_escalation", "cam_reconciliation", "insurance_renewal", "tax_appeal_deadline", "inspection", "custom"]),
  date: z.string(),
  description: z.string().optional(),
  status: z.enum(["upcoming", "acknowledged", "completed", "missed"]).default("upcoming"),
